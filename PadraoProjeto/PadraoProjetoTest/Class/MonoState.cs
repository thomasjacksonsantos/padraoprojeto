namespace UnitTestProject1.Class
{
    ...
    public class Turnstile
    {
        ...
        private static int itsRefounds = 0;

        protected readonly static Turnstile LOCKED = new Locked();

        protected readonly static Turnstile UNLOCKED = new Unlocked();
        ...
        public int Refunds { get { return itsRefounds; } }
